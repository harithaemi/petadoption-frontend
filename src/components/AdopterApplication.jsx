  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:7777/adoption/adoptionapplication",
        {
          pet: id,
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-3">
            Tell us a little about yourself and why you would like to adopt.
          </p>
        </div>
          ...
          <div className="border-t pt-6">
            ...
            <div className="mb-7">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                1. Do you stay in a house or apartment?
              </h3>

              <div className="flex flex-col md:flex-row gap-3">
                <label className="flex items-center gap-3 border border-red-100 rounded-lg p-3 cursor-pointer hover:bg-red-50 md:w-1/2">
                  <input
                    type="radio"
                    name="residenceType"
                    value="House"
            ...
            <div className="mb-7">
              ...
              <div className="flex gap-3">
                <label className="flex items-center gap-3 border border-red-100 rounded-lg p-3 cursor-pointer hover:bg-red-50 w-1/2">
                  <input
                    type="radio"
                    name="petFriendly"
                    value="true"
            ...
            <div className="mb-7">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                4. Do you have permission to keep a pet?
              </h3>
            ...
            <div className="mb-7">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                5. Have you previously raised a pet?
              </h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                6. Tell us why you would like to adopt this pet
              </h3>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="5"
                placeholder="Tell us about yourself, your experience with pets and why you would like to adopt..."
